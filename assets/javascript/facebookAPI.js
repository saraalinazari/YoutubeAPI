...
// grant_type=client_credentials
    ...
    var queryURL="https://graph.facebook.com/v2.11/10207157941490688/photos?fields=height,width,link&access_token=258507278047521|zcxXsMKuAnK4UYnpRSjiPy5YaHo"
    $.ajax({
              url: queryURL,
              method: "GET"
            }).then(function(response) {
